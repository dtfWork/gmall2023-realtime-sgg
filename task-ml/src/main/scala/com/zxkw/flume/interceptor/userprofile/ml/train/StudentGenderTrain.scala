package com.zxkw.flume.interceptor.userprofile.ml.train

import java.util.Properties
import com.zxkw.flume.interceptor.userprofile.common.util.MyPropertiesUtil
import com.zxkw.flume.interceptor.userprofile.ml.pipeline.MyPipeline
